...
public class GlobalSettings {
	 ...
	 */
	public final static double INTEGRAL_FEINHEIT = 5.e-4;

	/**
	 * fineness parameter for differentiation
	 */
	public final static double DERIVATIVE_FEINHEIT = 1.e-8;

	/**
	 * fineness on real line
	 */
	public final static double REAL_EQUALITY_FEINHEIT = 1.e-8;
