...
//	private static final int polynomialDegree = 10;
...
//	
//	final Function sinSquared=new GenericFunction() {
//		@Override
//		public Scalar value(Scalar input) {
//			return new Real(Math.pow(Math.sin(input.getValue()), 2));
//		}
//	};
//	
...
//				.getPolynomialSobolevSpace(RealLine.getInstance(), polynomialDegree, 1, sobolevDegree);
...
//	@Test
//	public void test3() {
//		final Function sineSquaredProjection = sineSquared.getProjection(linearSpace);
//		staircaseFunction2.plotCompare(-1, 1, staircaseFunction2Projection);
//	}
//
//}
