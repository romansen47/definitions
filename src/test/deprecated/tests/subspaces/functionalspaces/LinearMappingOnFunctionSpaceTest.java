...
// import
// definitions.structures.generic.finitedimensional.defs.vectors.impl.GenericFunction;
//
...
//
// space =
// Generator.getGenerator().getSpacegenerator().getTrigonometricSpace(1);
//
...
//
// composition =
// (Generator.getGenerator().getMappinggenerator().getComposition(map2, map));
...
// System.out.println(vec.getKey().toString() + ": " +
// vec.getValue().toString());
// }
// }
//
// }
