...
//		extendedSpace = new FiniteDimensionalFunctionSpace(list, -Math.PI, Math.PI);
		...
		final FiniteDimensionalEmbedding parametrization = (FiniteDimensionalEmbedding) Generator.getGenerator()
				.getMappinggenerator().getFiniteDimensionalLinearMapping(space, extendedSpace, coordinates2);

		spaceAsSubSpace = new FiniteDimensionalFunctionSubSpace(parametrization, extendedSpace);
